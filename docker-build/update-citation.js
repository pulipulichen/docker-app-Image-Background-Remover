...
const package_info = JSON.parse(fs.readFileSync(path.resolve(__dir, '../package.json', 'utf-8')).toString())
...
fs.writeFileSync(path.resolve(__dir, '../CITATION.cff', citation_cff_yaml, 'utf-8'))
